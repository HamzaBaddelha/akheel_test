...
export default function ArticleContent() {
  ...
  const sections = sectionIds.map((id) => ({
    title: t(`blogArticleMedinas.sections.${id}.title`),
    body: t(`blogArticleMedinas.sections.${id}.body`),
  }));
      ...
      <Container className="space-y-10 sm:space-y-14">
        ...
        <section className="rounded-container border border-primary/25 bg-primary p-7 text-background shadow-sm sm:p-10">
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            >
              {t("blogArticleMedinas.cta.primary")}
            </Link>
            <Link
              href="/plan-your-trip"
            ...
            >
              {t("blogArticleMedinas.cta.secondary")}
            </Link>
          </div>
        </section>
      </Container>
